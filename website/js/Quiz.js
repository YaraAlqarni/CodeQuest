...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", (e) => {
        ...
        resultHTML = `
        <h2 style="text-align:center;">You scored ${score} out of ${total}</h2>
        ${resultHTML}
...
`;
        ...
        // Send the score and phone to the server
        fetch('/submit-score', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            // Now, once the score is successfully sent, replace the body with the result
